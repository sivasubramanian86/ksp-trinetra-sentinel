...
def generate_test_images():
    os.makedirs("data/sample_test_images", exist_ok=True)
    ...
    img_ocr.save("data/sample_test_images/ocr_test_plate.png")
    print("[OK] Generated data/sample_test_images/ocr_test_plate.png")
    ...
    img_doc.save("data/sample_test_images/document_test.png")
    print("[OK] Generated data/sample_test_images/document_test.png")
    ...
    img_bc.save("data/sample_test_images/barcode_test.png")
    print("[OK] Generated data/sample_test_images/barcode_test.png")
